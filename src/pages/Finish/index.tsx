  ...
  return (
    <GradientContainer>
      <Container>
        ...
        <BoxButton>
          <ButtonSecondary onPress={() => navigation.navigate('categories')}>
            <TitleButtonSecondary>Continuar</TitleButtonSecondary>
          </ButtonSecondary>
          <ButtonPrimary onPress={goToFeedback}>
            <TitleButtonPrimary>Respostas</TitleButtonPrimary>
          </ButtonPrimary>
        </BoxButton>
      </Container>
    </GradientContainer>
