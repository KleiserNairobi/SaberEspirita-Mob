...
export function CreateQuiz() {
  ...
  function validate() {
    ...
    if (!inputs.correctAnswer) {
      ...
      handleError(
        'A resposta correta deve ter no máximo 150 caracteres.',
        'correctAnswer',
      );
      valid = false;
    }
    if (!inputs.wrongAnswer1) {
      ...
      handleError(
        'A resposta incorreta deve ter no máximo 150 caracteres.',
        'wrongAnswer1',
      );
      valid = false;
    }
  ...
  return (
    <GradientContainer>
      <Container>
        ...
        <Subtitle>
          Contribua com o Saber Espírita! Crie perguntas e respostas exclusivas
          e compartilhe seu conhecimento com a comunidade.
        </Subtitle>
